...
public class Resta {
	...
	private List <Integer> resta = new ArrayList <Integer>();
	
	private char [] array1;
	private char [] array2;
	
	public Resta(String cadena){
	...
	public String toString() {
		return "Intersecion [inter=" + resta + ", array1=" + Arrays.toString(array1) + ", array2="
